...
import i5.las2peer.services.res2.database.DatabaseManager;
import java.sql.*;
  ...
  @SwaggerDefinition(
      info = @Info(title = "115", version = "$Metadata_Version$",
          ...
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-115/blob/master/LICENSE.txt") ) )
  @Path("/")
