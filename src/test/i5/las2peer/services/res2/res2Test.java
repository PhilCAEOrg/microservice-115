 ...
 * 115 - Test Class
 *
 * This class provides a basic testing framework for the microservice 115. It was
...
public class res2Test {
  ...
  public void testm2() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/m2", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testm2': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
